    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(upload_to='publication_pics/', validators=[Biotics.publications.validators.validate_file_size])),
                ...
                ('type_of_publication', models.CharField(blank=True, choices=[('Botany', 'Botany'), ('Microbiology', 'Microbiology'), ('Zoology', 'Zoology')], max_length=13)),
