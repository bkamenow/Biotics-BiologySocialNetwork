"""
URL configuration for Biotics project.
...
urlpatterns = [
    ...
    path('events/', include('Biotics.events.urls')),
    path('trainings/', include('Biotics.trainings.urls')),
    path('messaging/', include('Biotics.messaging.urls')),
